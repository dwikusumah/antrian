			...
			<div class="vertical-align-middle">
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							<div class="header">
								<p class="lead">Masuk utnuk Pengguna</p>
							</div>
							<form class="form-auth-small" method="POST" action="<?php echo base_url('Login_c/authlogin'); ?>">
								<div class="form-group">
									<label for="signin-email" class="control-label sr-only">Nama pengguna</label>
									<input type="text" class="form-control" id="signin-email" placeholder="Nama pengguna" name="username_c" required=""> 
								</div>
								<div class="form-group">
									<label for="signin-password" class="control-label sr-only">Kata sandi</label>
									<input type="password" class="form-control" id="signin-password" placeholder="Kata sandi" name="password_c" required=""> 
								</div>
								<div class="form-group clearfix"></div>
								<input type="submit" class="btn btn-primary btn-lg btn-block" value="Masuk"/>
								<input type="button" class="btn btn-primary btn-lg btn-block" value="Kembali" onclick ='top.location="LandingPage"' />
