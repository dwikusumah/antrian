									...
									if ($list) {
										foreach ($list as $value) {
											...
											<div class="form-group">
												<label for="nama-staff">Nama</label>
												<input id="nama-staff" name="nama-staff" type="text" value="<?php echo $value['nama_staff']; ?>" class="form-control" placeholder="Nama staff" required="">
											</div>
											<div class="form-group">
