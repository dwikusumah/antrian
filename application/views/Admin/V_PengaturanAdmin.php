	...
	<div class="sidebar-scroll">
		<nav>
			...
			<li><a class="active" href="<?php echo base_url('DashboardAdmin'); ?>" ><i class="lnr lnr-home"></i><span>Dashboard</span></a></li>
				...
				<li><a href="<?php echo base_url('DataBarang/index'); ?>" class=""><i class="lnr lnr-list"></i> <span>Barang</span></a></li> 
				<li><a href="<?php echo base_url('DataTransaksi/index'); ?>" class=""><i class="lnr lnr-cart"></i> <span>Transaksi</span></a></li>
