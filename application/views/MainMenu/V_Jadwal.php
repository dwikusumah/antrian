...
<body class="landing-page sidebar-collapse">
  <nav class="navbar fixed-top navbar-expand-lg bg-warning" id="sectionsNav">
    <div class="container">
      <div class="navbar-translate"> <a class="title">Aplikasi Antrian</a>
  ...
  <div class="main main-raised" style="margin-top: 0.5%;">
    <div class="container">
      <div class="section section-contacts">
        <div class="row">
          <div class="col-md-12">
            <h2 class="text-center title">Jadwal</h2>
            <h4 class="text-center description" style="margin-bottom: 40px;">Berikut adalah daftar jadwal staff</h4>
            <div class="panel">
